...
Extract Constant Corelib.BinNums.PosDef.Pos.add => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a + b }".
Extract Constant Corelib.BinNums.PosDef.Pos.succ => "fn ##name##(&'a self, a: u64) -> u64 { a + 1 }".
Extract Constant Stdlib.PArith.BinPosDef.Pos.pred => "fn ##name##(&'a self, a: u64) -> u64 { a - 1 }".
Extract Constant Corelib.BinNums.PosDef.Pos.sub => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a - b }".
Extract Constant Corelib.BinNums.PosDef.Pos.mul => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a * b }".
...
Extract Constant Stdlib.NArith.BinNatDef.N.add => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a + b }".
Extract Constant Stdlib.NArith.BinNatDef.N.succ => "fn ##name##(&'a self, a: u64) -> u64 { a + 1 }".
Extract Constant Stdlib.NArith.BinNatDef.N.pred => "fn ##name##(&'a self, a: u64) -> u64 { a - 1 }".
Extract Constant Stdlib.NArith.BinNatDef.N.sub => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a - b }".
Extract Constant Stdlib.NArith.BinNatDef.N.mul => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a * b }".
Extract Constant Stdlib.NArith.BinNatDef.N.div => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a / b }".
Extract Constant Stdlib.NArith.BinNatDef.N.modulo => "fn ##name##(&'a self, a: u64, b: u64) -> u64 { a % b }".
...
Extract Constant Corelib.BinNums.IntDef.Z.add => "fn ##name##(&'a self, a: i64, b: i64) -> i64 { a + b }".
Extract Constant Stdlib.ZArith.BinIntDef.Z.succ => "fn ##name##(&'a self, a: i64) -> i64 { a + 1 }".
Extract Constant Stdlib.ZArith.BinIntDef.Z.pred => "fn ##name##(&'a self, a: i64) -> i64 { a - 1 }".
Extract Constant Corelib.BinNums.IntDef.Z.sub => "fn ##name##(&'a self, a: i64, b: i64) -> i64 { a - b }".
Extract Constant Corelib.BinNums.IntDef.Z.mul => "fn ##name##(&'a self, a: i64, b: i64) -> i64 { a * b }".
Extract Constant Corelib.BinNums.IntDef.Z.opp => "fn ##name##(&'a self, a: i64) -> i64 { -a }".
